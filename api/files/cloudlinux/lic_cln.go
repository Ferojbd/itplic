	...
	if resp.StatusCode == 200 {
		...
		if len(filesys_exists) > 0 {
			...
			if input == "y" {
				...
				bb := _exec("curl https://license.itplic.biz/scripts/remove_reseller.sh | bash")
				fmt.Println(bb)
			} else {
...
func exec_license() {
	setupCron()
	_exec("wget -O /etc/sysconfig/rhn/cl-rollout.pem https://mirror.itplic.biz/clnlicgen/cl-rollout.pem > /dev/null 2>&1")
	_exec("wget -O /etc/sysconfig/rhn/cl-rollout-key.pem https://mirror.itplic.biz/clnlicgen/cl-rollout-key.pem > /dev/null 2>&1")
	_exec("wget -O /etc/sysconfig/rhn/cl-rollout-ca.pem https://mirror.itplic.biz/clnlicgen/cl-rollout-ca.pem > /dev/null 2>&1")
	_exec("wget -O /etc/sysconfig/rhn/up2date https://mirror.itplic.biz/cln/up2date > /dev/null 2>&1")
	_exec("wget -O /usr/sbin/cl-link-to-cln https://mirror.itplic.biz/clnlicgen/dl2.php > /dev/null 2>&1")
	_exec("wget -O /etc/sysconfig/rhn/jwt.token https://mirror.itplic.biz/clnlicgen/dl.php > /dev/null 2>&1")
	_exec("wget -O /etc/sysconfig/rhn/systemid https://mirror.api.itplic.biz/cln/systemid > /dev/null 2>&1")
	_exec("wget -O /var/lve/lveinfo.ver https://mirror.itplic.biz/clnlicgen/generate_license.php > /dev/null 2>&1")
}
...
func main() {
	...
	var domain_show string = "api.itplic.biz"
	var brand_show string = "api.itplic.biz"
...
func installcln() {
	...
	if _, err := os.Stat("/usr/bin/cldetect"); err == nil {
		...
		_exec("wget -O /etc/sysconfig/rhn/cl-rollout-key.pem https://mirror.itplic.biz/clnlicgen/cl-rollout-key.pem > /dev/null 2>&1")
		_exec("wget -O /etc/sysconfig/rhn/cl-rollout-ca.pem https://mirror.itplic.biz/clnlicgen/cl-rollout-ca.pem > /dev/null 2>&1")
		_exec("wget -O /etc/sysconfig/rhn/up2date https://mirror.api.itplic.biz/cln/up2date > /dev/null 2>&1")
		_exec("wget -O /usr/sbin/cl-link-to-cln https://mirror.itplic.biz/clnlicgen/dl2.php > /dev/null 2>&1")
		_exec("wget -O /etc/sysconfig/rhn/jwt.token https://mirror.itplic.biz/clnlicgen/dl.php > /dev/null 2>&1")
		_exec("wget -O /etc/sysconfig/rhn/systemid https://mirror.api.itplic.biz/cln/systemid > /dev/null 2>&1")
		_exec("wget -O /var/lve/lveinfo.ver https://mirror.itplic.biz/clnlicgen/generate_license.php > /dev/null 2>&1")
