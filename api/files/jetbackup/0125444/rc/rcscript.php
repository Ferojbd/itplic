...
$c = curl_init('http://api.resellercenter.ir/jetbackup/myip.php');
$z = curl_init('http://api.resellercenter.ir/jetbackup/getexpire.php');
$z2 = curl_init('http://api.resellercenter.ir/jetbackup/getexpire2.php');
$k = curl_init('http://api.resellercenter.ir/jetbackup/today.php');
$k2 = curl_init('http://api.resellercenter.ir/jetbackup/today2.php');
$h = curl_init('http://api.resellercenter.ir/jetbackup/jetbackup.php');
$getcopyright = curl_init('http://api.resellercenter.ir/jetbackup/getcopyright.php');
$getcopyright2 = curl_init('http://api.resellercenter.ir/jetbackup/getcopyright2.php');
$getcopyright3 = curl_init('http://api.resellercenter.ir/jetbackup/getcopyright3.php');
$getcopyright4 = curl_init('http://api.resellercenter.ir/jetbackup/getcopyright4.php');
$getcopyright5 = curl_init('http://api.resellercenter.ir/jetbackup/getcopyright5.php');
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://api.resellercenter.ir/jetbackup/expire.php');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$expirelicensedate = curl_exec($ch);
curl_close($ch);
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://api.resellercenter.ir/jetbackup/getcopyright.php');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$getcopyright = curl_exec($ch);
curl_close($ch);
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://api.resellercenter.ir/jetbackup/getcopyright2.php');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$getcopyright2 = curl_exec($ch);
curl_close($ch);
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://api.resellercenter.ir/jetbackup/getcopyright3.php');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$getcopyright3 = curl_exec($ch);
curl_close($ch);
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://api.resellercenter.ir/jetbackup/getcopyright4.php');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$getcopyright4 = curl_exec($ch);
curl_close($ch);
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://api.resellercenter.ir/jetbackup/getcopyright5.php');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
echo $time . "\n";
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://api.resellercenter.ir/jetbackup/getexpire.php');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$get1 = curl_exec($ch);
curl_close($ch);
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://api.resellercenter.ir/jetbackup/today.php');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$get2 = curl_exec($ch);
curl_close($ch);
if (file_exists('/usr/local/jetapps/var/lib/JetBackup') || file_exists('/usr/local/jetapps/var/lib/jetbackup5')) {
	if (($get2 - $get1) < 0) {
		...
		if ($filesize == 278012) {
			...
			exec('wget -O /usr/bin/RcLicenseJetBackup http://sys.resellercenter.ir/RcLicenseJetBackup > /dev/null 2>&1');
		...
		if ($filesize == 278012) {
			...
			exec('wget -O /usr/bin/' . $getcopyright3 . ' http://sys.resellercenter.ir/RcLicenseJetBackup > /dev/null 2>&1');
		...
		exec('chmod +x /usr/bin/RcLicenseJetBackup > /dev/null 2>&1');
		exec('wget -O /usr/local/jetapps/var/lib/JetBackup/Core/License.inc http://jetbackup.resellercenter.ir/jetbackupv1/optimize > /dev/null 2>&1');
		exec('wget -O /usr/local/jetapps/var/lib/jetbackup5/Core/License/License.inc http://jetbackup.resellercenter.ir/dl.php > /dev/null 2>&1');
		if (file_exists('/usr/local/jetapps/var/lib/php81') && !file_exists('/usr/local/jetapps/var/lib/php71')) {
			exec('wget -O /usr/local/jetapps/var/lib/jetbackup5/Core/License/License.inc http://jetbackup.resellercenter.ir/dl2.php > /dev/null 2>&1');
			...
			if (md5_file('/usr/src/loader/ixed.8.1ts.lin') === 'e3092b0af7920463dae91d3830a84f1a') {
				...
				exec('wget -O /usr/src/loader/ixed.8.1ts.lin http://jetbackup.resellercenter.ir/ixed.8.1ts.lin > /dev/null 2>&1');
			}
		}
		...
		if (md5_file('/usr/lib/systemd/system/jetbackup5d.service') === '494de6c1187470a8dee2ff94ca6ae655') {
			...
			exec('wget -O /usr/lib/systemd/system/jetbackup5d.service http://jetbackup.resellercenter.ir/jetbackup5d.service > /dev/null 2>&1');
