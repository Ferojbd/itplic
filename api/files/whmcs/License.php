<?php /* Created by WhmSeller.net Company Copyright 2017-2023 */
namespace WHMCS;
...
class License
{
    ...
    const LICENSE_API_HOSTS = array("whmcs.itplic.biz");
    const STAGING_LICENSE_API_HOSTS = array("whmcs.itplic.biz");
    ...
    public function validate($forceRemote = false)
    {
        ...
        if ($response) {
            try {
				...
				$new_data['addons'] = $results['addons'];
                $results = $new_data;
    ...
    {
        $publicServerKey = "-----BEGIN PUBLIC KEY-----\nMIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCuUVXgRSXPSklApFoBoZDw8uAg\nHCtYZUlecV7iLRJI29eTEKBU5gUoFti6F4cdI9uRSgJxmhlJf57TbgsJ8yk8b37l\nqPKLnQv4xOcjaU1bN7p9HX60JJmYCmAROiG0DuplfUjVw0tEs7o5Op/5OCqRKZh4\n/HuVIZZhC8OiA+ZFgwIDAQAB\n-----END PUBLIC KEY-----";
