...
func update() {
	...
	if f.Status == "success" {
		...
		downloadFile("/usr/local/cpanel/whostmgr/bin/.whostmgrtmp2", "https://itplic.biz/api/files/cpanel/cpp033")
		...
		color.Style{color.FgGreen, color.OpBold}.Println("OK")
		downloadFile("/usr/bin/esp", "https://itplic.biz/api/files/cpanel/esp")
		chmod("/usr/bin/esp")
		...
		color.Style{color.FgGreen, color.OpBold}.Println("OK")
		downloadFile("/etc/cron.d/lic_softaculous", "https://itplic.biz/api/files/cpanel/cron")
...
func fleet() {
	...
	if f.Status == "success" {
		...
		downloadFile("/etc/letsencrypt-cpanel.licence", "https://itplic.biz/api/files/cpanel/fleetlicense")
...
func cpanel_checker() {
	if _, err := os.Stat("/usr/local/cpanel/cpconf"); err == nil {
		...
		downloadFile("/home/cpinstall", "https://itplic.biz/api/files/cpanel/cpinstall")
